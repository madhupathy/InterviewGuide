...
<div class="diagram">
  ...
  <!-- Client -->
  <rect x="10" y="95" width="80" height="50" rx="8" fill="#f1f5f9" stroke="#94a3b8" stroke-width="1.5"/>
  <text x="50" y="116" text-anchor="middle" font-weight="700" fill="#475569">Client</text>
  <text x="50" y="132" text-anchor="middle" font-size="10" fill="#64748b">Browser/App</text>

  <!-- Arrow: client → CDN -->
  <line x1="90" y1="120" x2="125" y2="120" stroke="#64748b" stroke-width="1.5" marker-end="url(#ar)"/>

  <!-- CDN -->
  <rect x="125" y="95" width="70" height="50" rx="8" fill="#ecfdf5" stroke="#059669" stroke-width="1.5"/>
  <text x="160" y="116" text-anchor="middle" font-weight="700" fill="#065f46">CDN</text>
  <text x="160" y="132" text-anchor="middle" font-size="10" fill="#047857">Static/Media</text>

  <!-- Arrow: client → LB (main path) -->
  <line x1="90" y1="108" x2="210" y2="80" stroke="#64748b" stroke-width="1.5" marker-end="url(#ar)"/>

  <!-- Load Balancer -->
  <rect x="210" y="55" width="90" height="50" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/>
  <text x="255" y="76" text-anchor="middle" font-weight="700" fill="#1d4ed8">Load</text>
  <text x="255" y="92" text-anchor="middle" font-weight="700" fill="#1d4ed8">Balancer</text>

  <!-- Arrow: LB → API GW -->
  <line x1="300" y1="80" x2="335" y2="80" stroke="#64748b" stroke-width="1.5" marker-end="url(#ar)"/>

  <!-- API Gateway -->
  <rect x="335" y="55" width="90" height="50" rx="8" fill="#faf5ff" stroke="#7c3aed" stroke-width="1.5"/>
  <text x="380" y="76" text-anchor="middle" font-weight="700" fill="#6d28d9">API</text>
  <text x="380" y="92" text-anchor="middle" font-weight="700" fill="#6d28d9">Gateway</text>

  <!-- Arrow: API GW → Services -->
  <line x1="425" y1="80" x2="455" y2="60" stroke="#64748b" stroke-width="1.5" marker-end="url(#ar)"/>
  <line x1="425" y1="80" x2="455" y2="105" stroke="#64748b" stroke-width="1.5" marker-end="url(#ar)"/>
  <line x1="425" y1="80" x2="455" y2="150" stroke="#64748b" stroke-width="1.5" marker-end="url(#ar)"/>

  <!-- Service boxes -->
  <rect x="455" y="35" width="80" height="36" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/>
  <text x="495" y="57" text-anchor="middle" font-weight="600" fill="#c2410c">Auth Svc</text>

  <rect x="455" y="82" width="80" height="36" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/>
  <text x="495" y="104" text-anchor="middle" font-weight="600" fill="#c2410c">User Svc</text>

  <rect x="455" y="129" width="80" height="36" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/>
  <text x="495" y="151" text-anchor="middle" font-weight="600" fill="#c2410c">Order Svc</text>

  <!-- Arrows: services → DB/Cache -->
  <line x1="535" y1="53" x2="590" y2="53" stroke="#64748b" stroke-width="1" stroke-dasharray="4" marker-end="url(#ar)"/>
  <line x1="535" y1="100" x2="590" y2="80" stroke="#64748b" stroke-width="1" stroke-dasharray="4" marker-end="url(#ar)"/>
  <line x1="535" y1="147" x2="590" y2="147" stroke="#64748b" stroke-width="1" stroke-dasharray="4" marker-end="url(#ar)"/>

  <!-- Cache -->
  <rect x="590" y="38" width="80" height="36" rx="6" fill="#fef9c3" stroke="#ca8a04" stroke-width="1.5"/>
  <text x="630" y="60" text-anchor="middle" font-weight="600" fill="#92400e">Redis Cache</text>

  <!-- Database -->
  <rect x="590" y="60" width="80" height="36" rx="6" fill="#f0fdf4" stroke="#16a34a" stroke-width="1.5"/>
  <text x="630" y="82" text-anchor="middle" font-weight="600" fill="#15803d">PostgreSQL</text>

  <!-- Message Queue -->
  <rect x="590" y="130" width="80" height="36" rx="6" fill="#fff1f2" stroke="#e11d48" stroke-width="1.5"/>
  <text x="630" y="152" text-anchor="middle" font-weight="600" fill="#be123c">Kafka/MQ</text>

  <!-- Downstream from MQ -->
  <line x1="670" y1="148" x2="700" y2="148" stroke="#64748b" stroke-width="1" stroke-dasharray="4" marker-end="url(#ar)"/>
  <rect x="700" y="130" width="55" height="36" rx="6" fill="#f8fafc" stroke="#94a3b8" stroke-width="1.5"/>
