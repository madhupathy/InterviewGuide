...
<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:12px;margin:16px 0">
  <div class="home-card" onclick="showPage('sd-intro')">
    ...
    <div class="hc-desc">Framework, estimation, 11 patterns, building blocks, case studies</div>
  </div>
  <div class="home-card" onclick="toggleSub('sd-dist-sub'); showPage('sd-msgqueue')">
    <div class="hc-icon">🌐</div>
    <div class="hc-title">Distributed Systems</div>
    <div class="hc-desc">Message queues, Kafka vs RabbitMQ, eventing, trade-offs</div>
  </div>
  ...
  <div class="home-card" onclick="showPage('java-core')">
    ...
    <div class="hc-desc">Core OOP, Collections, Concurrency, Streams, Memory/JVM</div>
  </div>
  ...
  <div class="home-card" onclick="showPage('go-core')">
    <div class="hc-icon">🐹</div>
    <div class="hc-title">Golang</div>
    <div class="hc-desc">Goroutines, channels, concurrency patterns, worker pools</div>
  </div>
  <div class="home-card" onclick="showPage('k8s-core')">
    <div class="hc-icon">☸️</div>
    <div class="hc-title">Kubernetes</div>
    <div class="hc-desc">Architecture, troubleshooting, CRDs, Observability, GPU Operator</div>
  </div>
  <div class="home-card" onclick="showPage('ds-revision')">
    <div class="hc-icon">📋</div>
    <div class="hc-title">Revision Tracker</div>
    <div class="hc-desc">Mark topics mastered or for review, track your progress</div>
  </div>
</div></div>
...
<div class="callout amber">
  <strong>Questions to always ask:</strong> Read/write ratio? Scale (daily users, requests/sec)? Consistency vs availability tradeoff? Global or single region? Any existing systems to integrate with?
</div>
...
<div class="diagram">
  <svg viewBox="0 0 740 180" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:740px;font-family:'DM Sans',sans-serif;font-size:12px;display:block;margin:0 auto">
  <defs>
    <marker id="ar" markerWidth="8" markerHeight="8" refX="7" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#94a3b8"/></marker>
  </defs>

  <!-- Row 1: Client → CDN → LB → API GW -->
  <rect x="5" y="60" width="75" height="42" rx="8" fill="#f1f5f9" stroke="#94a3b8" stroke-width="1.5"/>
  <text x="42" y="78" text-anchor="middle" font-weight="700" font-size="12" fill="#475569">Client</text>
  <text x="42" y="92" text-anchor="middle" font-size="9" fill="#94a3b8">Browser / App</text>

  <line x1="80" y1="81" x2="108" y2="81" stroke="#94a3b8" stroke-width="1.5" marker-end="url(#ar)"/>

  <rect x="108" y="60" width="65" height="42" rx="8" fill="#ecfdf5" stroke="#059669" stroke-width="1.5"/>
  <text x="140" y="78" text-anchor="middle" font-weight="700" font-size="12" fill="#065f46">CDN</text>
  <text x="140" y="92" text-anchor="middle" font-size="9" fill="#059669">Static assets</text>

  <line x1="173" y1="81" x2="198" y2="81" stroke="#94a3b8" stroke-width="1.5" marker-end="url(#ar)"/>

  <rect x="198" y="56" width="82" height="50" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/>
  <text x="239" y="77" text-anchor="middle" font-weight="700" font-size="12" fill="#1d4ed8">Load</text>
  <text x="239" y="92" text-anchor="middle" font-weight="700" font-size="12" fill="#1d4ed8">Balancer</text>

  <line x1="280" y1="81" x2="305" y2="81" stroke="#94a3b8" stroke-width="1.5" marker-end="url(#ar)"/>

  <rect x="305" y="56" width="78" height="50" rx="8" fill="#faf5ff" stroke="#7c3aed" stroke-width="1.5"/>
  <text x="344" y="77" text-anchor="middle" font-weight="700" font-size="12" fill="#6d28d9">API</text>
  <text x="344" y="92" text-anchor="middle" font-weight="700" font-size="12" fill="#6d28d9">Gateway</text>

  <!-- Fan-out arrows to services -->
  <line x1="383" y1="70" x2="415" y2="30" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar)"/>
  <line x1="383" y1="81" x2="415" y2="81" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar)"/>
  <line x1="383" y1="92" x2="415" y2="135" stroke="#94a3b8" stroke-width="1.2" marker-end="url(#ar)"/>

  <!-- Services column -->
  <rect x="415" y="12" width="80" height="34" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/>
  <text x="455" y="33" text-anchor="middle" font-weight="600" font-size="11" fill="#c2410c">Auth Svc</text>

  <rect x="415" y="64" width="80" height="34" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/>
  <text x="455" y="85" text-anchor="middle" font-weight="600" font-size="11" fill="#c2410c">User Svc</text>

  <rect x="415" y="118" width="80" height="34" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/>
  <text x="455" y="139" text-anchor="middle" font-weight="600" font-size="11" fill="#c2410c">Order Svc</text>

  <!-- Storage column -->
  <line x1="495" y1="29" x2="540" y2="29" stroke="#d1d5db" stroke-width="1" stroke-dasharray="4" marker-end="url(#ar)"/>
  <line x1="495" y1="81" x2="540" y2="60" stroke="#d1d5db" stroke-width="1" stroke-dasharray="4" marker-end="url(#ar)"/>
  <line x1="495" y1="135" x2="540" y2="135" stroke="#d1d5db" stroke-width="1" stroke-dasharray="4" marker-end="url(#ar)"/>

  <rect x="540" y="12" width="80" height="34" rx="6" fill="#fef9c3" stroke="#ca8a04" stroke-width="1.5"/>
  <text x="580" y="33" text-anchor="middle" font-weight="600" font-size="11" fill="#92400e">Redis</text>

  <rect x="540" y="50" width="80" height="34" rx="6" fill="#f0fdf4" stroke="#16a34a" stroke-width="1.5"/>
  <text x="580" y="71" text-anchor="middle" font-weight="600" font-size="11" fill="#15803d">PostgreSQL</text>

  <rect x="540" y="118" width="80" height="34" rx="6" fill="#fff1f2" stroke="#e11d48" stroke-width="1.5"/>
  <text x="580" y="139" text-anchor="middle" font-weight="600" font-size="11" fill="#be123c">Kafka</text>

  <!-- Workers -->
  <line x1="620" y1="135" x2="650" y2="135" stroke="#d1d5db" stroke-width="1" stroke-dasharray="4" marker-end="url(#ar)"/>
  <rect x="650" y="118" width="70" height="34" rx="6" fill="#f8fafc" stroke="#94a3b8" stroke-width="1.5"/>
  <text x="685" y="139" text-anchor="middle" font-weight="600" font-size="11" fill="#64748b">Workers</text>
</svg>
</div>
...
${quizHTML('sd-framework', [
  { q: "What's the first thing to do in a system design interview?", opts: ["Estimate QPS", "Choose the database", "Clarify functional and non-functional requirements for 5 minutes", "Draw the architecture"], ans: 2, exp: "Jumping straight to drawing is the #1 mistake. Spend 5 minutes asking: What does the system do? Who uses it? What scale? Read/write ratio? Consistency vs availability? Interviewers reward structured thinking." },
  { q: "What should a high-level design contain?", opts: ["5–6 boxes: Client → LB → Service → DB/Cache — the architecture skeleton", "Complete API specification", "Detailed caching strategy", "Full DB schema and indexes"], ans: 0, exp: "High-level design is deliberately coarse. Show the main components and data flow. Client → Load Balancer → Services → Databases/Cache. No implementation details yet — those come in the deep dive." },
  { q: "When should you pick NoSQL over SQL?", opts: ["For financial transactions", "When you need massive horizontal scale, flexible schema, or very high write throughput", "Always — NoSQL is faster", "When you need complex JOINs"], ans: 1, exp: "Use SQL for: transactions, complex queries, relationships. Use NoSQL for: high write throughput (Cassandra), flexible/nested documents (MongoDB), key-value caching (Redis), time-series (InfluxDB). Most systems use both." },
  { q: "What does 'deep dive' mean in the SD interview framework?", opts: ["Rewrite the high-level design", "Pick 2–3 critical components and explain design decisions, bottlenecks, and trade-offs in detail", "Discuss team structure", "Draw all DB tables"], ans: 1, exp: "Deep dive = show expertise on specific components. Pick the hardest parts: How does the fan-out work? How do you handle hotspot users? How does the cache invalidation work? Walk through failure scenarios." },
  { q: "How do you estimate if a system needs sharding?", opts: ["When latency exceeds 1 second", "Shard when you have 1M users", "Always shard from day 1", "When single DB can't handle the QPS or storage after read replicas and caching are exhausted"], ans: 3, exp: "Scaling order: 1) Vertical scale-up, 2) Read replicas + caching (handles 90% of read-heavy problems), 3) Shard only if write QPS or storage exceeds single node. Sharding adds huge complexity — don't do it early." },
  { q: "What is the CAP theorem trade-off in practice?", opts: ["Between latency and throughput", "Choose between CPU and memory", "Between SQL and NoSQL", "During a network partition: serve stale data (AP) or refuse requests (CP)"], ans: 3, exp: "Since network partitions ALWAYS happen eventually, CAP means: CP systems (Zookeeper, etcd) stop accepting writes to maintain consistency. AP systems (Cassandra, DynamoDB) serve potentially stale data to stay available." },
  { q: "A system needs 99.99% availability. How many minutes of downtime/year is that?", opts: ["~5 minutes", "~52 minutes", "52 minutes", "8.7 hours"], ans: 1, exp: "99.99% ('four nines') = 0.01% downtime = 365.25 × 24 × 60 × 0.0001 = 52.6 minutes/year. 99.9% = 8.7 hours/year. 99.999% = 5.25 minutes/year. Know these by heart for the requirements discussion." },
  { q: "What's the difference between stateless and stateful services?", opts: ["No difference in practice", "Stateful is always faster", "Stateless: any server handles any request (horizontally scalable). Stateful: server holds session state (sticky sessions or external state store needed)", "Stateless requires a database"], ans: 2, exp: "Stateless services store all state externally (DB, Redis, JWT token). Any server can handle any request → simple horizontal scaling. Stateful services need sticky sessions or shared state (Redis, DB). Design microservices to be stateless." },
  { q: "What is a message queue used for in system design?", opts: ["Load balancing", "Decoupling services, absorbing traffic spikes, enabling async processing of slow operations", "Speeding up synchronous API calls", "Replacing the database"], ans: 1, exp: "Message queues (Kafka, SQS, RabbitMQ) decouple producers from consumers. Benefits: absorb traffic bursts (queue builds up instead of dropping requests), retry on failure, async processing (email, notifications, video transcoding), fan-out to multiple consumers." }
])}
...
${quizHTML('sd-estimation', [
  { q: "1 million requests/day is approximately how many QPS?", opts: ["~1,000 QPS", "~12 QPS", "~100 QPS", "~50 QPS"], ans: 1, exp: "1M ÷ 86,400 ≈ 11.6, round to ~12 QPS. Key formula: divide daily requests by 100,000 (10^5) for a quick mental estimate. So 100M/day ≈ 1,160 QPS." },
  { q: "Which operation is approximately 200,000× slower than an L1 cache hit?", opts: ["SSD read", "RAM", "L2 cache", "Cross-region call"], ans: 1, exp: "RAM access (~100ns) vs L1 cache (~0.5ns) = 200× slower. SSD is ~2,000,000× slower. Understanding this hierarchy explains why we cache aggressively." },
  { q: "For a read-heavy system (100:1 ratio), what's the most effective scaling strategy?", opts: ["Add Redis cache + read replicas, cache the hot 20%", "Use stronger consistency", "Increase server RAM only", "Add more write shards"], ans: 0, exp: "Pareto: 20% of content = 80% of reads. Cache hot 20% in Redis (80GB fits comfortably). Add read replicas to distribute DB reads. This handles 10-100× more load with minimal cost." },
  { q: "A tweet is ~300 bytes. 300M tweets/day = how much storage?", opts: ["~90 MB", "~9 TB", "~90 TB", "~90 GB"], ans: 3, exp: "300M × 300 bytes = 90 GB/day for text only. Add metadata (~500B/tweet) = 300M × 800B = ~240 GB/day. Over 5 years text alone = ~440 TB. Always estimate text and media separately." },
  { q: "Peak traffic is typically how many times average?", opts: ["Same as average", "50× average", "2× average", "5–10× average"], ans: 3, exp: "System design rule: always plan for 5–10× peak vs average. Twitter at noon vs 3am is ~5× difference. Black Friday for e-commerce is 10×+. Always multiply your QPS estimate by 5 for capacity planning." }
,
  { q: "How many bytes is a typical user profile row in a database?", opts: ["~1 KB (name, email, bio, timestamps, preferences)", "~1 MB", "~10 bytes", "~100 bytes"], ans: 0, exp: "User profile: name(50B) + email(100B) + bio(500B) + created_at(8B) + settings JSON(200B) ≈ 1 KB. Always break down row sizes field by field in interviews — it shows you understand data modelling." },
  { q: "Netflix serves 15M concurrent streams at 5 Mbps each. Total bandwidth?", opts: ["750 Gbps", "7.5 Tbps", "75 Gbps", "75 Tbps"], ans: 3, exp: "15M × 5 Mbps = 75M Mbps = 75 Tbps. This is why Netflix uses CDN edge nodes — no single datacenter handles this. Real Netflix: ~135 Tbps peak (mix of HD and 4K). Always convert to Tbps for big-scale media services." },
  { q: "How many servers handle 350,000 reads/sec for a Twitter-like system?", opts: ["3,500 servers", "~35 servers (10K req/s per server, +50% buffer = 53 total)", "350 servers", "1 server"], ans: 1, exp: "Rule of thumb: 1 commodity server handles ~10K req/s for simple read APIs (stateless, cached responses). 350K ÷ 10K = 35 servers. Always add 50% capacity buffer for peak: 35 × 1.5 ≈ 53 servers. More for write-heavy or compute-heavy workloads." },
  { q: "Storage for 1 billion users with profile photos (100KB avg): how much?", opts: ["~100 GB", "~1 TB", "~100 PB", "~100 TB"], ans: 3, exp: "1B users × 100KB = 100 TB just for profile photos. With thumbnails at 3 sizes: 100TB × 3 = 300 TB. Over 5 years if 20% new users/year: ~500 TB total. This fits on S3/GCS with tiered storage. Always separate media storage from DB storage in estimates." }
])}
`;
...
${quizHTML('sd-patterns', [
  { q: "A social media feed has 100:1 read/write ratio. Which pattern?", opts: ["Transactional", "Read-Heavy", "Write-Heavy", "Real-Time"], ans: 1, exp: "Read-Heavy pattern. Solution: Redis cache in front of DB, read replicas, CDN for media. The mantra is 'don't make the DB do work reads can avoid'." },
  { q: "Payment system — most critical requirement?", opts: ["ACID transactions + idempotency keys", "High throughput", "Eventual consistency", "Low latency CDN"], ans: 0, exp: "Transactional pattern. Payments need ACID guarantees (SQL), idempotency keys to prevent duplicate charges, and row-level locking to prevent double-spend." },
  { q: "Video transcoding of uploaded files. Which pattern?", opts: ["Real-Time Processing", "Write-Heavy", "Async/Event-Driven Processing", "Read-Heavy"], ans: 2, exp: "Async/Event-Driven. Video transcoding is slow (minutes). Pattern: upload → S3 → event triggers → Kafka/SQS → worker pool → transcode to multiple resolutions → store back in S3." },
  { q: "'Accept fast, process later' describes which pattern?", opts: ["Synchronous Request-Reply", "Write-Behind / Async Queue", "Read-Through", "Cache-Aside"], ans: 1, exp: "Write-Behind / Async Queue. Write to a fast queue (Kafka/SQS), return 202 Accepted immediately, process asynchronously. Used for: email sending, analytics ingestion, order processing." },
  { q: "IoT sensors sending 1M events/sec. What pattern handles ingestion?", opts: ["REST API with synchronous DB writes", "Transactional with 2PC", "Read-Heavy with heavy caching", "Write-Heavy streaming ingestion with time-series DB"], ans: 3, exp: "Write-Heavy streaming. Ingest via Kafka (buffer spikes), write to time-series DB (InfluxDB/TimescaleDB optimised for sequential writes). Never write 1M/sec directly to a relational DB." },
  { q: "Global CDN is an example of which pattern?", opts: ["Write-Through", "Read-Heavy Cache-Aside", "Async Processing", "Geo-Distributed / Edge pattern"], ans: 3, exp: "Geo-Distributed / Edge pattern. Cache static assets at edge nodes close to users. Reduces origin server load, lowers latency (100ms → 5ms). CloudFront, Fastly, Cloudflare all implement this." },
  { q: "Which pattern uses fan-out on write?", opts: ["Read-Heavy (fan-out on read)", "Event Sourcing", "Social Graph / Feed (fan-out on write)", "Transactional"], ans: 2, exp: "Fan-out on write: when a celebrity posts, pre-compute and push to all followers' feed caches immediately. Expensive on write (1 post → 10M writes) but blazing fast reads. Twitter uses a hybrid: fan-out for regular users, fan-in for celebrities." },
  { q: "Circuit breaker pattern prevents what?", opts: ["Memory leaks", "SQL injection", "Data corruption", "Cascading failures — one slow service taking down all dependents"], ans: 3, exp: "Circuit breaker: after N failures, open the circuit → fail fast (return cached/default response immediately instead of waiting). Prevents thread pool exhaustion spreading a failure to all upstream services. Resilience4j, Hystrix implement this." },
  { q: "Event sourcing stores what instead of current state?", opts: ["Every event/change that happened — current state derived by replaying events", "Snapshots every minute", "Only the latest 100 events", "Compressed binary state"], ans: 0, exp: "Event sourcing: append OrderCreated, ItemAdded, PaymentMade events. Current state = replay. Benefits: full audit log, time travel, event replay for new projections. Used by Kafka Streams, Axon Framework, banking systems." }
])}
...
<div style="display:flex;flex-wrap:wrap;gap:8px;margin-bottom:20px">
  ${['scaling','load-balancing','caching','databases','cap','sharding','replication','acid','indexes','apis','auth'].map((s,i)=>`<button class="pill-tab${i===0?' active':''}" onclick="showBlock('${s}',this)">${['Scaling','Load Balancing','Caching','SQL vs NoSQL','CAP & PACELC','Sharding','Replication','ACID','Indexes','APIs','Auth'][i]}</button>`).join('')}
</div>

<div id="block-scaling" class="block-section">
...
${quizHTML('bb-scaling', [
  { q: "What's the typical scaling order before resorting to database sharding?", opts: ["Microservices first", "Shard immediately", "Add more RAM only", "Vertical scale → Cache (Redis) → Read replicas → CDN → Horizontal app servers → Async queues → Sharding"], ans: 3, exp: "Each step adds ~10× capacity. Sharding is operationally the most expensive — most systems never need it. Start simple: bigger server → Redis cache → read replicas → CDN for static content → stateless app servers behind LB → async processing via queues." },
  { q: "1 Redis node handles approximately how many ops/sec?", opts: ["~100,000 ops/sec with sub-millisecond latency", "10,000", "1 million", "1,000"], ans: 0, exp: "Redis: ~100K ops/sec single-threaded. PostgreSQL: ~5K writes/sec. Single web server: ~10K req/sec. These numbers help you estimate when you need the next scaling step." }
])}
</div>

<div id="block-load-balancing" class="block-section" style="display:none">
...
${quizHTML('bb-lb', [
  { q: "L7 load balancer advantage over L4?", opts: ["Handles more connections", "Lower cost", "Routes by URL/headers enabling path-based routing, A/B testing, SSL termination", "Lower latency"], ans: 2, exp: "L4 routes by IP/port only — fast but dumb. L7 understands HTTP: can route /api → service A, /static → CDN, add headers, terminate SSL. AWS ALB is L7; NLB is L4." },
  { q: "API Gateway vs Reverse Proxy — when do you need an API Gateway?", opts: ["Only for microservices", "Never — reverse proxy does everything", "When you need cross-cutting API concerns: auth, rate limiting per key, request transformation, versioning", "Always"], ans: 2, exp: "Reverse Proxy: LB + SSL + caching (simpler). API Gateway adds: authentication, per-user rate limiting, request/response transformation, API versioning, analytics. Use API Gateway when you have multiple client types (web, mobile, third-party) needing different API behaviors." }
])}
</div>
...
<span class="kw">if</span> (redis.set(lockKey, <span class="str">"1"</span>, <span class="str">"NX"</span>, <span class="str">"EX"</span>, <span class="num">10</span>)) {
  ...
  <h2 class="section-title" style="margin-top:20px">Cache Metrics — Hit Ratio</h2>
  <div class="callout callout-blue">
    <strong>Hit Ratio</strong> = cache hits / total requests. This is the single most important cache metric — it tells you whether the cache is actually helping.
  </div>
  <table class="data-table">
    <tr><th>Hit Ratio</th><th>Meaning</th><th>Action</th></tr>
    <tr><td>&gt; 90%</td><td>Cache is very effective — most requests served from cache</td><td>Good. Monitor for regressions.</td></tr>
    <tr><td>70–90%</td><td>Healthy for most read-heavy workloads</td><td>Acceptable. Can tune TTL or size for improvement.</td></tr>
    <tr><td>50–70%</td><td>Mediocre — half the requests still hit the DB</td><td>Review: cache size too small? TTL too short? Wrong data cached?</td></tr>
    <tr><td>&lt; 50%</td><td>Cache is doing more harm than good (overhead &gt; benefit)</td><td>Rethink what you cache. May indicate unique-per-user data that shouldn't be cached.</td></tr>
  </table>
  <div class="callout callout-amber">
    <strong>Quick math:</strong> A 90% hit ratio on a 10K req/sec service means the DB only sees 1K req/sec — a 10× effective capacity multiplier. Raising hit ratio from 90% → 95% doubles this again (DB now sees 500 req/sec).
  </div>

  <h2 class="section-title" style="margin-top:20px">Bloom Filter — Probabilistic Membership Test</h2>
  <div class="callout callout-blue">
    A space-efficient data structure that answers <em>"is this key <strong>possibly</strong> in the set?"</em> with zero false negatives but allowed false positives. Uses a bit array + k hash functions. Used in front of expensive lookups (DB, disk cache) to skip work that would definitely miss.
  </div>
  <div style="background:var(--surface);border:1px solid var(--border);border-radius:10px;padding:16px;font-family:'DM Mono',monospace;font-size:13px;line-height:2;margin:14px 0">
    <strong>Insert "apple"</strong>: hash1("apple")=3, hash2("apple")=7, hash3("apple")=12 → set bits 3, 7, 12 to 1<br>
    <strong>Check "apple"</strong>: bits 3, 7, 12 all 1 → "possibly present" (might be a collision, verify in DB)<br>
    <strong>Check "zebra"</strong>: hash1("zebra")=4 → bit 4 is 0 → <strong>definitely not present</strong> ✅ (skip DB entirely)
  </div>
  <table class="data-table">
    <tr><th>Property</th><th>Detail</th></tr>
    <tr><td><strong>False negatives</strong></td><td>Never — if "definitely not in set" says so, it's correct</td></tr>
    <tr><td><strong>False positives</strong></td><td>Possible — tuned via bit array size and number of hash functions</td></tr>
    <tr><td><strong>Space</strong></td><td>~10 bits per element for 1% false positive rate (vs. storing full keys)</td></tr>
    <tr><td><strong>Operations</strong></td><td>Add and Query in O(k). No delete (use Counting Bloom Filter for that)</td></tr>
  </table>
  <div class="callout callout-green">
    <strong>Real-world uses:</strong> Cassandra/LevelDB use bloom filters to avoid disk reads for keys that don't exist. Chrome uses them for malicious URL checking. CDNs use them to avoid checking origin for content that's never been cached. Medium uses one to check if you've already seen an article.
  </div>

${quizHTML('bb-caching', [
  { q: "Write-through vs write-behind cache — key trade-off?", opts: ["No difference", "Write-through: consistent but slower writes. Write-behind: fast writes but risk data loss if cache crashes before DB flush", "Write-through loses data", "Write-behind is always better"], ans: 1, exp: "Write-through: write to cache AND DB synchronously → data consistent but 2× write latency. Write-behind: write to cache, return to client, flush to DB async → fast but if cache crashes before flush = data lost. Use write-through for financial data, write-behind for analytics counters." },
  { q: "Redis Sentinel vs Redis Cluster — when to choose Cluster?", opts: ["Cluster is simpler", "Always use Cluster", "Sentinel is deprecated", "When dataset exceeds single node memory or you need horizontal write scaling — Cluster shards across 16,384 hash slots"], ans: 3, exp: "Sentinel: 1 primary + N replicas, auto-failover, all data on every node. Good for <25GB datasets. Cluster: data sharded across nodes, each shard has its own replicas. Needed when data exceeds single-node memory or write throughput exceeds single-primary capacity." }

  ,
  { q: "Cache hit ratio drops from 90% to 50% — what does that mean in effective DB load?", opts: ["Hit ratio doesn't affect DB", "DB load stays the same", "DB load halves", "DB load grows 5x — at 90% hit ratio DB sees 10% of requests; at 50% it sees 50%"], ans: 3, exp: "Hit ratio is the fundamental cache metric. 90% hit ratio means 10% of requests hit the DB. 50% hit ratio means 50% hit the DB — so DB load went from 10% to 50%, which is 5x. This is why monitoring hit ratio is critical — a slow degradation can silently overload your database." },
  { q: "Bloom filter — which of these is a core guarantee?", opts: ["Perfect accuracy with O(1) space", "Supports deletion out of the box", "No false positives, false negatives possible", "No false negatives — if it says 'not in set', that's definitely true. False positives are possible."], ans: 3, exp: "Bloom filters guarantee zero false negatives but allow false positives. If the filter says 'possibly present', you still verify against the source. If it says 'definitely not present', you skip the expensive lookup entirely. Cassandra/LevelDB use this to avoid disk reads. Standard bloom filters don't support delete — use Counting Bloom Filter for that." }
])}
</div>
...
${quizHTML('bb-cap', [
  { q: "In a distributed system during network partition, which should a payment system prioritise?", opts: ["Neither matters", "Partition tolerance can be avoided", "Availability — always respond", "Consistency (CP) — refuse stale reads to prevent double-spending"], ans: 3, exp: "Payments need CP: if two servers have different balances during a partition, a user could spend money they don't have. Accept higher latency and reduced availability during partitions to guarantee correct data. Use PostgreSQL with serializable isolation." },
  { q: "SAGA vs 2-Phase Commit — why prefer SAGA?", opts: ["SAGA uses local transactions with compensating actions — no cross-service locks, better availability than 2PC which holds distributed locks", "SAGA is simpler", "No difference", "2PC is deprecated"], ans: 0, exp: "2PC: coordinator holds locks on ALL participating services during both phases — one slow service blocks everyone, coordinator crash = all locked. SAGA: each step is a local transaction; on failure, run compensating transactions in reverse. No global locks → much better availability and performance." }
])}
</div>
...
${quizHTML('bb-shard', [
  { q: "Consistent hashing main advantage over hash(key) % N?", opts: ["Faster computation", "Adding/removing a node only moves ~1/N keys instead of reshuffling almost everything", "Simpler implementation", "Better distribution"], ans: 1, exp: "With hash(key) % N: changing N causes nearly ALL keys to rehash — catastrophic cache miss storm. Consistent hashing: keys and nodes sit on a ring. Adding a node only affects keys between the new node and its predecessor (~1/N of total). Used by Cassandra, DynamoDB, CDNs." }
])}
</div>
...
${quizHTML('bb-repl', [
  { q: "W=2, R=2, N=3 quorum — what does this guarantee?", opts: ["No guarantees", "At least 1 node overlaps between write and read sets — guarantees reading the latest write (strong consistency)", "2 writes per second", "Faster reads"], ans: 1, exp: "W+R > N means read and write sets overlap. With N=3, W=2, R=2: writes go to 2 of 3 nodes, reads check 2 of 3 nodes. At least 1 node has the latest write AND is read → strong consistency. Cassandra uses this with CONSISTENCY QUORUM." }
])}
...
${quizHTML('bb-acid', [
  { q: "MVCC (Multi-Version Concurrency Control) — what problem does it solve?", opts: ["Disk space", "Network latency", "Schema changes", "Readers don't block writers and writers don't block readers — each transaction sees a consistent snapshot without locks"], ans: 3, exp: "Without MVCC: reads must wait for writes to complete (or vice versa) via locks → poor concurrency. With MVCC (PostgreSQL, MySQL InnoDB): each transaction sees a snapshot of the DB at its start time. Writes create new versions, reads see the version valid at their snapshot time. No read locks needed." }
])}
...
${quizHTML('bb-idx', [
  { q: "Composite index (a, b, c) — which query does NOT use it?", opts: ["WHERE a=1", "WHERE a=1 AND b=2 AND c=3", "WHERE b=2 (skips leftmost column a — index unusable)", "WHERE a=1 AND b=2"], ans: 2, exp: "Leftmost prefix rule: composite index (a,b,c) supports queries that start from the left. WHERE a=1 ✅, WHERE a=1 AND b=2 ✅, WHERE a=1 AND b=2 AND c=3 ✅. But WHERE b=2 ❌ (skips 'a'). WHERE a=1 AND c=3 partially uses index (only 'a' part)." }
])}
</div>
...
<svg viewBox="0 0 600 260" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:600px;display:block;margin:0 auto;font-family:'DM Sans',sans-serif">
  <defs>
    <marker id="af" markerWidth="8" markerHeight="8" refX="7" refY="3" orient="auto"><path d="M0,0 L0,6 L8,3 z" fill="#64748b"/></marker>
  </defs>
  <!-- Top question -->
  <rect x="180" y="10" width="240" height="50" rx="10" fill="#f8fafc" stroke="#374151" stroke-width="2"/>
  <text x="300" y="32" text-anchor="middle" font-size="13" font-weight="600" fill="#111827">Is the API client-facing</text>
  <text x="300" y="48" text-anchor="middle" font-size="13" font-weight="600" fill="#111827">or internal?</text>

  <!-- Left arrow: Client-facing -->
  <line x1="220" y1="60" x2="120" y2="115" stroke="#64748b" stroke-width="2" marker-end="url(#af)"/>
  <text x="155" y="85" font-size="12" font-weight="600" fill="#64748b">Client-facing</text>

  <!-- Right arrow: Internal -->
  <line x1="380" y1="60" x2="490" y2="115" stroke="#64748b" stroke-width="2" marker-end="url(#af)"/>
  <text x="430" y="85" font-size="12" font-weight="600" fill="#64748b">Internal</text>

  <!-- gRPC box (right) -->
  <rect x="440" y="115" width="120" height="45" rx="8" fill="#dcfce7" stroke="#16a34a" stroke-width="2.5"/>
  <text x="500" y="143" text-anchor="middle" font-size="16" font-weight="700" fill="#065f46">gRPC</text>

  <!-- Second question (left) -->
  <rect x="20" y="115" width="200" height="50" rx="10" fill="#f8fafc" stroke="#374151" stroke-width="2"/>
  <text x="120" y="137" text-anchor="middle" font-size="12" font-weight="600" fill="#111827">Over/under-fetching</text>
  <text x="120" y="153" text-anchor="middle" font-size="12" font-weight="600" fill="#111827">a concern?</text>

  <!-- Yes → GraphQL -->
  <line x1="60" y1="165" x2="60" y2="200" stroke="#64748b" stroke-width="2" marker-end="url(#af)"/>
  <text x="40" y="185" font-size="11" font-weight="600" fill="#64748b">Yes</text>
  <rect x="10" y="200" width="110" height="45" rx="8" fill="#dbeafe" stroke="#2563eb" stroke-width="2.5"/>
  <text x="65" y="228" text-anchor="middle" font-size="15" font-weight="700" fill="#1e40af">GraphQL</text>

  <!-- No → REST -->
  <line x1="180" y1="165" x2="230" y2="200" stroke="#64748b" stroke-width="2" marker-end="url(#af)"/>
  <text x="210" y="185" font-size="11" font-weight="600" fill="#64748b">No</text>
  <rect x="190" y="200" width="100" height="45" rx="8" fill="#fef2f2" stroke="#dc2626" stroke-width="2.5"/>
  <text x="240" y="228" text-anchor="middle" font-size="16" font-weight="700" fill="#991b1b">REST</text>

  <!-- Labels underneath -->
  <text x="65" y="255" text-anchor="middle" font-size="10" fill="#94a3b8">Mobile BFF, flexible queries</text>
  <text x="240" y="255" text-anchor="middle" font-size="10" fill="#94a3b8">Public APIs, CRUD</text>
  <text x="500" y="172" text-anchor="middle" font-size="10" fill="#94a3b8">Low-latency, streaming</text>
</svg>
</div>
...
${quizHTML('bb-apis', [
  { q: "REST vs gRPC — when to choose gRPC for microservices?", opts: ["Always use REST", "Only for Google services", "gRPC when browser support needed", "gRPC for internal services: binary Protocol Buffers, HTTP/2 multiplexing, native streaming — 5-10× less overhead than JSON/HTTP"], ans: 3, exp: "gRPC wins for internal service-to-service: Protocol Buffers ~6× smaller than JSON, HTTP/2 multiplexes streams on one connection, native bi-directional streaming. Use REST for public APIs and browser clients." },
  { q: "PUT vs PATCH — when to use PATCH?", opts: ["PATCH is deprecated", "Always use PUT", "They're identical", "PATCH for partial updates — only sends changed fields. PUT replaces the entire resource (missing fields get nulled)"], ans: 3, exp: "PUT: send complete object — server replaces everything. If you omit a field, it becomes null. PATCH: send only what changed — server merges with existing. Use PATCH for most updates (safer). Use PUT when intentionally replacing the full resource." }
])}
</div>
...
${quizHTML('bb-auth', [
  { q: "JWT vs Session tokens — key difference?", opts: ["No difference", "JWT is always encrypted", "JWT is stateless (server doesn't store it) — session tokens require server-side storage (Redis/DB) for lookup", "Sessions are stateless"], ans: 2, exp: "Session: server stores session data (Redis/DB), sends session ID cookie to client, every request = server lookup. JWT: all claims encoded in the token itself (base64 header.payload.signature), server verifies signature without storage. JWT scales better (no shared session store) but can't be revoked instantly." },
  { q: "mTLS vs regular TLS — what's different?", opts: ["mTLS is faster", "In mTLS BOTH client AND server present certificates — mutual authentication, preventing rogue services from impersonating legitimate ones", "mTLS uses different encryption", "Regular TLS is more secure"], ans: 1, exp: "Regular TLS: only server proves identity (presents certificate). Client trusts server but server doesn't verify client. mTLS: both sides present certificates. Server verifies client is authorized. Used for service-to-service auth in microservices (Istio enables this cluster-wide)." }
])}
</div>
...
${quizHTML('sd-auth', [
  { q: "JWT vs Session tokens — key difference?", opts: ["No difference", "Sessions are more secure", "JWT is stateless (server holds no state); sessions require server-side storage", "JWT is always encrypted"], ans: 2, exp: "Session: server stores session data (Redis/DB), client gets opaque ID. JWT: all data in the token, server only verifies signature — no storage. JWT enables stateless horizontal scaling but can't be revoked without a blocklist." },
  { q: "OAuth2 is for?", opts: ["Hashing tokens", "Encrypting passwords", "Authenticating users (proving identity)", "Authorisation — granting third-party apps limited access to your resources"], ans: 3, exp: "OAuth2 = Authorisation (what you can access). OpenID Connect (OIDC) = Authentication on top of OAuth2 (who you are). When you 'Login with Google', OAuth2 grants access, OIDC provides identity (id_token with user info)." },
  { q: "When should you use API Keys over JWT?", opts: ["Browser-based SPAs", "Mobile apps", "Never — JWT is always better", "Server-to-server integrations, third-party developer access, rate-limiting by client"], ans: 3, exp: "API Keys: simple, long-lived, good for server-to-server or third-party developers. JWT: better for user sessions (short-lived, carries claims). API Keys are easy to audit, rotate, and rate-limit per key." },
  { q: "What is the purpose of a refresh token?", opts: ["Reset password", "Reload user profile", "Get new short-lived access tokens without re-authentication when access token expires", "Refresh the UI"], ans: 2, exp: "Access tokens are short-lived (15min–1hr) to limit damage if stolen. Refresh tokens are long-lived (days/weeks), stored securely (httpOnly cookie), used ONLY to get new access tokens. If refresh token is stolen, revoke it in the DB." },
  { q: "PKCE (Proof Key for Code Exchange) prevents what attack?", opts: ["JWT forgery", "Authorization code interception in mobile/SPA OAuth flows", "SQL injection", "CSRF attacks"], ans: 1, exp: "In public clients (mobile apps, SPAs), the authorization code could be intercepted. PKCE: generate random code_verifier → hash it (code_challenge) → send hash with auth request. Only the original app that sent the hash can exchange the code." },
  { q: "Where should JWTs be stored in a browser?", opts: ["sessionStorage", "localStorage (most convenient)", "window.token global variable", "httpOnly cookies (prevents XSS access) — NOT localStorage"], ans: 3, exp: "localStorage is accessible via JavaScript — XSS attack can steal it. httpOnly cookies can't be accessed by JS. Pair with SameSite=Strict/Lax to prevent CSRF. This is the recommended approach for auth tokens." },
  { q: "What is mTLS and when is it used?", opts: ["Mobile TLS protocol", "Mutual TLS — both client AND server present certificates, verifying each other's identity", "A compression algorithm", "Multi-factor TLS"], ans: 1, exp: "Normal TLS: only server proves identity (certificate). mTLS: both sides present certificates. Used for service-to-service auth in microservices (Istio implements this). Prevents man-in-the-middle between internal services." },
  { q: "Rate limiting by user vs by IP — which is harder to bypass?", opts: ["By IP (harder)", "By authenticated user ID (harder to bypass than IP, which can be spoofed/rotated)", "Neither can be bypassed", "Both equally hard"], ans: 1, exp: "IP-based limiting: attackers can use proxies, rotating IPs, botnets. User-ID based: requires authentication, much harder to get millions of accounts. Best: both layers — IP rate limiting for unauthenticated endpoints, user-ID for authenticated." },
  { q: "SSO (Single Sign-On) uses which protocols?", opts: ["HTTP Basic Auth", "SAML 2.0 (enterprise/XML) or OIDC (modern/JSON) — both enable one login for multiple apps", "Only JWT", "Only OAuth2"], ans: 1, exp: "SAML 2.0: XML-based, enterprise-focused (Okta, Active Directory). OIDC: JSON/JWT-based, modern web/mobile (Google, GitHub). Both allow one authentication session to grant access to multiple applications without re-login." }
])}
`;
...
${quizHTML('sd-ratelimit', [
  { q: "Why use a Lua script in Redis for rate limiting?", opts: ["To reduce network calls", "Lua executes atomically — prevents race conditions between GET and SET across multiple servers", "Redis only supports Lua", "Lua is faster than Python"], ans: 1, exp: "Without atomic execution, two servers could both read count=99 and both allow requests, setting count to 100+101. Lua in Redis is atomic — the entire check-and-increment is one operation, eliminating race conditions." },
  { q: "Token bucket vs sliding window log — main difference?", opts: ["Token bucket: O(1) memory, allows bursts. Sliding window log: exact, O(n) memory (stores every timestamp)", "Token bucket stores more data", "No real difference", "Window log is simpler"], ans: 0, exp: "Token bucket: 2 Redis keys, constant memory, allows burst up to bucket size. Sliding window log: one sorted set entry per request — O(n) memory. At 10K req/user/hour, log uses 10K entries vs bucket's 2 counters." },
  { q: "The 'boundary problem' affects which algorithm?", opts: ["Leaky bucket", "Fixed window counter — allows 2× the limit at window boundaries", "Token bucket", "Sliding window counter"], ans: 1, exp: "Fixed window: 100 req limit. User sends 100 at 11:59:59, then 100 more at 12:00:01. Both windows see 100 (within limit), but 200 requests happened in 2 seconds. Sliding window algorithms eliminate this." },
  { q: "Where should you implement rate limiting for a microservices system?", opts: ["At the DNS level", "In the database", "API Gateway for global limits + per-service middleware for fine-grained limits + Redis for distributed state", "Only in the application code"], ans: 2, exp: "Multi-layer approach: 1) API Gateway (Kong/AWS API GW) — first line of defense, per-API-key limits. 2) Service middleware — per-user, per-feature limits. 3) Redis — shared distributed counter. Defense in depth." },
  ...
  { q: "Sliding window counter is ~98% accurate. What causes the 2% error?", opts: ["Hash collisions in Redis", "Network latency", "Integer overflow", "It approximates the previous window's contribution using a weighted ratio, not exact timestamps"], ans: 3, exp: "Formula: count = prev_window_count × (1 - elapsed_in_current_window / window_size) + current_count. The approximation assumes requests were uniformly distributed in the previous window — which introduces a small error." },
  { q: "How do you handle rate limit for a celebrity user with millions of API calls?", opts: ["Give them a higher tier limit or whitelist, implement per-endpoint limits separately", "Move them to a dedicated server", "Use the same limit as everyone else", "Block them entirely"], ans: 0, exp: "Tiered limits: free=100/day, pro=10K/day, enterprise=unlimited (fair use). Whitelist internal services and trusted partners. For celebrity users in social apps, fan-out is the bigger problem — use async queues, not stricter rate limits." },
  { q: "What is the leaky bucket algorithm good for?", opts: ["Lowest memory usage", "Smoothing output rate — requests are processed at a constant rate regardless of burst input", "Highest accuracy", "Allowing burst traffic"], ans: 1, exp: "Leaky bucket: input flows in at variable rate, output leaks at fixed rate. Useful when you want smooth, predictable output (e.g., sending SMS/emails at a fixed rate to avoid overwhelming downstream). Unlike token bucket, NO bursting allowed." },
  { q: "How do you prevent rate limit bypass via multiple accounts?", opts: ["Device fingerprinting, IP-based secondary limits, anomaly detection, CAPTCHA on account creation", "You can't prevent it", "Only allow one account per email", "Use stronger encryption"], ans: 0, exp: "Defense layers: 1) IP rate limiting as secondary control, 2) Device fingerprinting, 3) ML-based anomaly detection (100 new accounts from same subnet), 4) Phone verification on signup, 5) Behavioral analysis (too-regular request patterns)." }
])}
`;
...
${quizHTML('sd-lru', [
  { q: "Why use a Doubly Linked List (not singly) for LRU?", opts: ["Memory efficiency", "O(1) removal requires both prev and next pointers — singly linked needs O(n) traversal to find prev", "Singly linked doesn't support null", "Doubly linked is simpler"], ans: 1, exp: "To remove a node: update prev.next and next.prev. With singly linked, you don't know prev without traversing from head — O(n). Doubly linked gives O(1) removal anywhere in the list." },
  { q: "LRU cache get() and put() should be?", opts: ["O(n)", "O(1)", "O(log n)", "O(n log n)"], ans: 1, exp: "HashMap: O(1) key lookup. Doubly linked list: O(1) insert/remove with node reference from map. Combined: both O(1). This is exactly why we combine these two data structures." },
  { q: "What does maxmemory-policy allkeys-lru do in Redis?", opts: ["Deletes all keys when full", "Only evicts keys with TTL", "Prevents new keys when full", "Evicts the least recently accessed key when maxmemory is reached"], ans: 3, exp: "Redis tracks last-access time per key. When maxmemory limit is hit, allkeys-lru finds and evicts the key not accessed longest. volatile-lru does the same but only for keys that have a TTL set." },
  { q: "LinkedHashMap in Java with accessOrder=true does what?", opts: ["Sorts by insertion time", "Compresses old entries", "Sorts by key alphabetically", "Maintains LRU order automatically — most recently accessed entry moves to tail"], ans: 3, exp: "new LinkedHashMap<>(cap, 0.75f, true) — the third param 'accessOrder=true' reorders entries on every get()/put(). Combined with overriding removeEldestEntry(), you get a working LRU cache in 10 lines." },
  { q: "LRU cache with capacity 3. Operations: put(1), put(2), put(3), get(1), put(4). What's evicted?", opts: ["Key 2 (LRU after get(1) made 1 recent)", "Key 3", "Key 1 (oldest)", "Key 4"], ans: 0, exp: "After put(1,2,3): order = [3,2,1] (3 most recent). get(1) makes 1 most recent: [1,3,2]. put(4) evicts LRU = key 2. Final cache: {1,3,4}. Always trace through the doubly linked list to verify." },
  { q: "What is a cache stampede and how to fix it for LRU?", opts: ["When LRU evicts too aggressively", "When cache miss triggers many simultaneous DB calls for same key — fix: mutex lock or probabilistic early expiry", "When cache gets too full", "When two keys hash to same bucket"], ans: 1, exp: "Stampede: popular key expires, 1000 requests simultaneously miss cache → 1000 DB queries. Fix: 1) Mutex: first thread queries DB, others wait, 2) Probabilistic early expiry (expire before TTL with some probability), 3) Background refresh before expiry." },
  { q: "Caffeine vs Guava cache for Java local caching?", opts: ["Guava is always better", "Guava has more features", "Caffeine is superior: W-TinyLFU eviction (better hit rate than LRU), near-optimal, faster, active development", "They are identical"], ans: 2, exp: "Caffeine uses W-TinyLFU (Window Tiny LFU) — a hybrid algorithm that tracks both frequency AND recency, outperforming pure LRU on most real workloads. It's the recommended replacement for Guava cache and is used by Spring Boot's default cache." },
  { q: "For a distributed cache, what's the consistency trade-off?", opts: ["Cache may serve stale data (AP) — choose TTL to balance freshness vs DB load", "No trade-off exists", "Must use strong consistency always", "Cache is always consistent"], ans: 0, exp: "Distributed cache is eventually consistent by design. TTL controls staleness: short TTL = fresher data, more DB hits; long TTL = stale data risk, fewer DB hits. For user profiles: 5 min TTL is fine. For inventory/prices: shorter TTL or event-based invalidation." },
  { q: "LRU cache size: 1M entries with 1KB average value. How much RAM?", opts: ["~100 MB", "~1 MB", "~1 TB", "~1 GB + overhead"], ans: 3, exp: "1M × 1KB = 1GB for values + HashMap overhead (~50 bytes/entry × 1M = 50MB) + DLL node overhead (~32 bytes × 1M = 32MB) ≈ 1.1GB total. Redis adds ~65 bytes per key overhead. Always estimate cache RAM requirements during system design." }
])}
`;
...
${quizHTML('sd-msgqueue', [
  { q: "Key difference between Kafka and RabbitMQ message retention?", opts: ["Both delete immediately", "No difference", "Kafka persists messages configurable forever allowing replay; RabbitMQ deletes on acknowledgment", "RabbitMQ keeps messages longer"], ans: 2, exp: "RabbitMQ: message is gone once a consumer acknowledges it — designed for task queues. Kafka: messages persist by time or size policy (days, forever). Multiple consumer groups can read the same message independently. Replay past events anytime." },
  { q: "Why is Kafka throughput orders of magnitude higher than RabbitMQ?", opts: ["Kafka uses more memory", "Kafka uses UDP", "Sequential disk writes + OS page cache + zero-copy sendfile + producer batching", "RabbitMQ limits connections"], ans: 2, exp: "Kafka's speed: 1) Sequential log appends (OS page cache ≈ RAM speed), 2) sendfile() zero-copy skips user-space, 3) Producer batching compresses 10-100 messages together, 4) Partitions allow N-parallel consumers. RabbitMQ maintains per-message ACK state — much more overhead." },
  { q: "Consumer groups in Kafka mean?", opts: ["Groups share a single offset", "Multiple independent groups each read ALL messages — billing and analytics can both consume orders independently", "Groups delete messages faster", "Only one consumer per topic"], ans: 1, exp: "Each consumer group maintains its own offset per partition. Add a new consumer group and it starts reading from the beginning (or any offset). This is Kafka's killer feature for event streaming — fanout to N systems with zero coupling." },
  { q: "What is a Dead Letter Queue in RabbitMQ?", opts: ["RabbitMQ's internal queue", "A backup queue", "A queue for system logs", "A queue receiving messages that failed processing — prevents poison messages blocking the main queue"], ans: 3, exp: "DLQ: when a message is rejected (consumer throws exception, TTL expires, max retries reached), it routes to the Dead Letter Exchange → Dead Letter Queue. Ops team can inspect, fix, and replay from DLQ. Critical for production reliability." },
  { q: "Kafka ordering guarantee — what's the caveat?", opts: ["Ordering guaranteed per partition only — not globally across all partitions", "No ordering at all", "Global ordering across all partitions", "Ordered by timestamp always"], ans: 0, exp: "Within a partition: strict offset order guaranteed. Across partitions: no global order. Solution: use a partition key (userId, orderId) — all messages for the same key go to the same partition, giving per-entity ordering. This is intentional — it enables parallelism." },
  { q: "Idempotent consumers in Kafka — why needed?", opts: ["Required by Kafka protocol", "Only for multi-partition topics", "For better performance", "At-least-once delivery can duplicate messages on failure — consumers must handle duplicate processing safely"], ans: 3, exp: "With at-least-once: consumer processes message, commits offset, but crashes before commit → message reprocessed. Make consumers idempotent: check if already processed (dedup by event ID), use DB upserts. Exactly-once Kafka transactions are available but add overhead." },
  { q: "When would you choose RabbitMQ over Kafka for a payment system?", opts: ["When scale exceeds 1M/sec", "Never — always use Kafka", "For task-queue style: each payment processed once, smart routing by payment type, simpler ops, no need for replay", "When using Python only"], ans: 2, exp: "Payment processing is often task-queue style: each message processed once, ACK on success, NACK (+ DLQ) on failure. RabbitMQ routing lets you send domestic vs international payments to different queues with different consumers. Much simpler than Kafka for moderate throughput." },
  { q: "What is Change Data Capture (CDC) with Kafka?", opts: ["A Kafka compression method", "Consumer group management", "Capturing every DB change as a Kafka event — Debezium reads MySQL/Postgres WAL and publishes changes as events", "A backup strategy"], ans: 2, exp: "CDC with Debezium: reads database WAL (Write-Ahead Log), publishes INSERT/UPDATE/DELETE as Kafka events. Use cases: sync DB to Elasticsearch, invalidate caches on DB change, audit trail, microservice event sourcing. Zero impact on application code." },
  { q: "Kafka partition count — why does it matter for scaling?", opts: ["More partitions = slower", "Partitions = max parallel consumers; 10 partitions = max 10 consumers in a group can process in parallel", "Partitions are unlimited", "Only affects storage"], ans: 1, exp: "Each partition assigned to at most one consumer per group. 3 partitions + 10 consumers = 3 active, 7 idle. To scale to 10 parallel consumers: need 10 partitions. Partitions can be increased (but causes rebalancing) — plan partition count for expected peak parallelism." }
])}
`;
...
${quizHTML('sd-tradeoffs', [
  { q: "Which consistency model should you use for a bank transfer?", opts: ["Either works", "Depends on bank size", "Strong consistency — stale balance = double spend", "Eventual consistency — faster"], ans: 2, exp: "Banking requires strong consistency. If two servers have different balances, a user could spend money they don't have or funds could be deducted twice. Use CP systems (Postgres with serializable isolation) and accept the latency cost." },
  { q: "REST vs gRPC — when to choose gRPC for microservices?", opts: ["gRPC only for Google services", "gRPC when browser support needed", "Always use REST", "gRPC for internal services: binary protocol, typed schema, streaming, 5-10x lower overhead than JSON/HTTP"], ans: 3, exp: "gRPC wins for internal microservices: Protocol Buffers are ~6x smaller than JSON, HTTP/2 multiplexes multiple streams on one connection, native bi-directional streaming. Use REST for public APIs and browser clients where gRPC-Web adds complexity." },
  { q: "WebSockets vs Long-Polling — main advantage of WebSockets?", opts: ["Simpler to implement", "Better security", "Persistent bi-directional connection with sub-millisecond latency vs new HTTP request per event", "Works without HTTP"], ans: 2, exp: "WebSockets: one persistent TCP connection, either side sends anytime, no HTTP overhead per message. Long-polling: must make new HTTP request after each event (connection setup/teardown overhead). For high-frequency real-time (gaming, collaborative editing, live trading): WebSockets." },
  { q: "Read-heavy system with 100:1 read/write ratio — first optimization?", opts: ["Shard the database immediately", "Switch to NoSQL", "Add Redis caching + read replicas — eliminates 80-90% of DB reads", "Add more write servers"], ans: 2, exp: "Pareto principle: 20% of content generates 80% of reads. Cache the hot 20% in Redis. Read replicas offload remaining reads from primary. This alone handles 100:1 read/write ratios. Only add sharding when write throughput or storage exceeds single node after these steps." },
  { q: "Stateless services: why are they easier to scale?", opts: ["Stateless services are always faster", "Any server can handle any request — add servers behind LB without sticky sessions or state sync", "They use less memory", "They don't need a database"], ans: 1, exp: "Stateless = all state in external store (DB, Redis, JWT token). Add 10 new servers: each can immediately serve any request. Stateful = must route same user to same server (sticky sessions) or sync session state across servers — complex, error-prone." },
  { q: "Token bucket vs leaky bucket — which allows bursts?", opts: ["Both allow identical bursts", "Neither allows bursts", "Token bucket — allows burst traffic up to bucket capacity before throttling", "Leaky bucket"], ans: 2, exp: "Token bucket: accumulates tokens up to capacity. A client that hasn't sent requests for a while has a full bucket and can burst. Leaky bucket: regardless of input burst, output is constant rate — overflow dropped. Token bucket is standard for API rate limiting." },
  { q: "When would you choose NoSQL over SQL?", opts: ["For all new projects after 2020", "Always — NoSQL is modern", "When you need massive horizontal scale, schema flexibility, or a specific data model (document, graph, time-series)", "When the team prefers it"], ans: 2, exp: "Default to SQL (PostgreSQL). Switch to NoSQL for: Cassandra (very high write throughput, multi-region), MongoDB (nested document structure, flexible schema), Redis (sub-ms caching), Neo4j (graph traversal), InfluxDB (time-series). 'Use the right tool' not 'use the new thing'." },
  { q: "CDN — what is the biggest challenge?", opts: ["Cache invalidation — stale content at edge nodes after origin updates", "Geographic coverage", "Cost", "Setting up origin pull"], ans: 0, exp: "CDN invalidation strategies: 1) Short TTL (content expires quickly but more origin hits), 2) Content-hash URLs (/app.a3f5b2.js — new deploy = new URL, cached forever), 3) API purge (CloudFront CreateInvalidation — instant but costs money). URL versioning is the most reliable approach." },
  { q: "Batch vs stream processing — which to use for fraud detection?", opts: ["Batch with 5-minute intervals", "Stream processing — analyze each transaction in real-time as it happens", "Both are equally good", "Batch — process daily transactions overnight"], ans: 1, exp: "Fraud detection requires stream processing: analyze each transaction the moment it occurs, flag and block before the fraudster gets away. Batch processing (nightly reports) would be useless — the fraudulent transactions have already completed." }
])}
`;
...
${quizHTML('sd-eventing', [
  { q: "What are the three pillars of observability?", opts: ["CPU, Memory, Network", "Latency, Throughput, Errors", "Availability, Performance, Security", "Logs (what happened), Metrics (aggregated numbers), Traces (request journey)"], ans: 3, exp: "Logs: timestamped events. Metrics: numeric aggregates (QPS, error rate). Traces: distributed request journey across services with timing. All three needed for complete debugging. Correlate them with a shared traceId in log fields." },
  { q: "Fluent Bit vs FluentD — which to use as a DaemonSet on K8s nodes?", opts: ["Both are identical", "Neither — use Prometheus instead", "FluentD — more plugins", "Fluent Bit — ~1MB memory vs FluentD ~40MB, designed for edge collection"], ans: 3, exp: "Fluent Bit: C-only, ~1MB memory, designed as lightweight forwarder. Perfect as DaemonSet. FluentD: Ruby/C, ~40MB, better for complex aggregation and routing. Common pattern: Fluent Bit (node DaemonSet) → FluentD (aggregator) → multiple destinations." },
  { q: "OpenTelemetry Collector main benefit?", opts: ["Requires Kubernetes", "Replaces Prometheus", "Vendor-neutral hub: apps instrument once, Collector fans out to Prometheus, Jaeger, Loki simultaneously", "Only for traces"], ans: 2, exp: "OTel Collector receives OTLP signals from apps → processes (batch, filter, enrich) → exports to multiple backends simultaneously. Change backends without touching app code. One SDK, any observability stack." },
  { q: "Prometheus scrape model — pull vs push?", opts: ["Both equally", "Pull — Prometheus scrapes /metrics endpoints at intervals", "Websocket streaming", "Push — apps send metrics"], ans: 1, exp: "Prometheus pulls: scrapes configured /metrics endpoints every N seconds. Benefits: easy to detect down services (scrape fails = down), no push config needed in apps, centrally controlled interval. Use Pushgateway for batch jobs that can't be scraped." },
  { q: "Structured logging main advantage over plain text?", opts: ["Smaller file size", "Faster to write", "JSON fields queryable by any key — userId, traceId, amount — enables filtering, alerting, correlation", "Required by Kubernetes"], ans: 2, exp: "Plain text: grep is the only tool. Structured JSON in Loki: {app='api'} | json | userId=12345 instantly finds all events for that user. Including traceId in every log line lets you jump from a log event directly to the distributed trace in Jaeger." },
  { q: "RED method stands for?", opts: ["Reliability, Efficiency, Durability", "Requests, Execution, Data", "Rate (req/s), Errors (error rate), Duration (latency p50/p95/p99)", "Response, Endpoint, Debugging"], ans: 2, exp: "RED = golden signals for measuring service health. Rate: requests per second. Errors: fraction that fail. Duration: how long they take. USE method (Utilization, Saturation, Errors) is for infrastructure resources. Dashboard with both covers 90% of incidents." },
  { q: "How do you correlate logs, metrics, and traces?", opts: ["Inject traceId into every log field + exemplar links in Prometheus + Grafana unified view", "Use a single tool only", "Not possible across different tools", "Timestamp matching only"], ans: 0, exp: "Correlation: 1) OTel SDK injects traceId into logs automatically, 2) Prometheus exemplars link metric data points to traces, 3) Grafana shows all three — click a spike → see logs for that window → jump to the specific trace. The traceId is the glue." },
  { q: "What is a Prometheus alert rule's 'for' duration used for?", opts: ["When to auto-resolve", "How long to collect data before alerting", "Must be in alert condition continuously for this duration before firing — prevents flapping on brief spikes", "Alert frequency"], ans: 2, exp: "Without 'for: 5m': a single-second spike fires the alert immediately. With 'for: 5m': condition must be true continuously for 5 minutes before PagerDuty rings. Prevents false alerts from brief traffic spikes. Set 'for' based on how long the problem must persist to be real." },
  { q: "Sidecar pattern for logging — what problem does it solve?", opts: ["Network routing", "App performance", "Security isolation", "Decouples app from log shipping — app writes to stdout, sidecar handles collection, parsing, forwarding without app changes"], ans: 3, exp: "Sidecar: Fluent Bit container in same pod as app. App writes logs to stdout/files, sidecar reads and ships to Loki. Apps don't need logging SDKs or network config. Change log destination by updating sidecar config only. Used by Istio (Envoy), FluentD, Vault agent." }
])}
`;
...
${quizHTML('sd-specdriven', [
  { q: "What problem does RAG solve?", opts: ["Gives LLMs access to up-to-date private knowledge without expensive fine-tuning — retrieve at query time", "Replaces the model entirely", "Reduces hallucinations to zero", "Makes LLMs faster"], ans: 0, exp: "RAG: at query time, embed the question → vector similarity search → inject top-K relevant chunks into the prompt → LLM answers using your data. No retraining needed. Knowledge can be updated by re-indexing documents. Cheaper than fine-tuning for factual knowledge." },
  { q: "What is MCP (Model Context Protocol)?", opts: ["A compression standard", "Open protocol for AI models to connect to external tools, databases, and services via a standard interface", "A training methodology", "A meta-learning algorithm"], ans: 1, exp: "MCP standardises how AI applications connect to capabilities — like USB-C for AI integrations. MCP servers expose tools (callable functions), resources (readable data), and prompts. Hosts like Claude Desktop, VS Code connect to any MCP server using the same protocol." },
  { q: "Chunking overlap (e.g., 10-20%) in RAG — why?", opts: ["Required by vector databases", "Reduces storage", "Improves embedding speed", "Preserves context at chunk boundaries — a sentence split across two chunks stays coherent"], ans: 3, exp: "Without overlap: a concept split across chunk boundary loses coherence — the embedding doesn't capture the full idea. With 50-token overlap: the tail of chunk N is repeated at the start of chunk N+1. Slightly more storage but much better retrieval quality for boundary queries." },
  { q: "pgvector vs Pinecone — when to choose pgvector?", opts: ["Pinecone only supports Python", "pgvector when you already use Postgres and have under ~10M vectors — no new infra, SQL queries work", "Always use Pinecone", "pgvector is always faster"], ans: 1, exp: "pgvector: PostgreSQL extension, add vector type to existing tables, combine with SQL filters, no new service. Perfect for smaller RAG systems already on Postgres. Pinecone/Qdrant for production scale (100M+ vectors), advanced filtering, or dedicated vector workloads." },
  { q: "ReAct pattern in agents — what does it stand for?", opts: ["Reasoning + Acting — LLM alternates between thinking about what to do and calling tools to do it", "REST and CRUD", "Reactive programming", "Real-time Actions"], ans: 0, exp: "ReAct loop: Thought (what do I need?) → Action (call tool) → Observation (tool result) → Thought → Action → ... until final answer. The model explicitly reasons about each step before acting. More reliable than pure end-to-end generation for multi-step tasks." },
  { q: "Semantic chunking advantage over fixed-size chunking?", opts: ["Required for OpenAI embeddings", "Always faster", "Uses less memory", "Splits where topic changes (semantic boundary) rather than at arbitrary token count — preserves coherent ideas in each chunk"], ans: 3, exp: "Fixed-size: may cut mid-sentence or mid-concept. Semantic: embed sentences, measure similarity to neighbours, split when similarity drops significantly — topic boundary. Better retrieval quality especially for documents that mix multiple topics. Higher compute cost." },
  { q: "Multi-agent system key design challenge?", opts: ["Writing prompt templates", "Preventing infinite loops, handling failures gracefully, coordinating state between agents without conflicts", "Setting up the database", "Choosing programming language"], ans: 1, exp: "Multi-agent challenges: 1) Infinite loops (set max_iterations), 2) Agent failures (retry/escalate/fallback), 3) State consistency (which agent's memory is authoritative?), 4) Cost control (each LLM call costs money), 5) Debugging (hard to trace multi-agent reasoning). Add circuit breakers and human checkpoints for high-stakes actions." }
])}
`;
